...
ragg::agg_png("figures/fig.quantile.SamplingPool.NRI.diffTemp.log.diffPrec.netDiv.png",
              width = 10.5*1.3, 
              height = 18*1.3, 
              units = "in",
              res = 750)

fig.quantile.SamplingPool.NRI.diffTemp.log.diffPrec.netDiv 

dev.off()

# ggsave("fig.quantile.SamplingPool.NRI.diffTemp.log.diffPrec.netDiv.png", 
#        plot = fig.quantile.SamplingPool.NRI.diffTemp.log.diffPrec.netDiv , 
#        device = "png", 
#        width = 10.5*1.2, 
#        height = 18*1.2, 
#        units = "in",
...
for(SamplingPool_i in levels(MPD.MNTD.LatLong.AllScales.raref.rel.worldClimate.diff.CWM.Div$SamplingPool)){
  for(X.var_i in c("diff.AnnTemp.LGM_cur", 
...
ragg::agg_png("figures/fig.quantile.SamplingPool.NTI.diffTemp.log.diffPrec.netDiv.png",
              width = 10.5*1.3, 
              height = 18*1.3, 
              units = "in",
              res = 750)
