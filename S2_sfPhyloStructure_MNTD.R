...
######## restriction to sampling pools (MNTD only)                               #####
#                                                                                    #
...
dim(MNTD.LatLong.Env.Realm); dim(MPD.LatLong.Env.Realm)
dim(MNTD.LatLong.Env.Plate); dim(MPD.LatLong.Env.Plate)
dim(MNTD.LatLong.Env.Biome); dim(MPD.LatLong.Env.Biome)
dim(MNTD.LatLong.Env.Ecoregion) ; dim(MPD.LatLong.Env.Ecoregion)
